...
SubProceso llenarMatriz_Z1(calculadora, cadena2)
	...
	Para i <- 0 Hasta 2 Hacer
		Para j <- 0 Hasta 2 Hacer
			calculadora(1,i,j) = ConvertirANumero(Subcadena(cadena2,k,k))
			k = k + 1
		FinPara
	FinPara
FinSubProceso
...
SubProceso imprimirMatriz(calculadora)
	...
	Para i <- 0 Hasta 2 Hacer
		Para j <- 0 Hasta 2 Hacer
			Escribir Sin Saltar "(",calculadora(0,i,j),")"
		FinPara
		Escribir ""
	FinPara
	Escribir "Capa 1"
	Para i <- 0 Hasta 2 Hacer
		Para j <- 0 Hasta 2 Hacer
			Escribir Sin Saltar "(",calculadora(1,i,j),")"
		FinPara
		Escribir ""
	FinPara
	Escribir "Capa 2"
	Para i <- 0 Hasta 2 Hacer
		Para j <- 0 Hasta 2 Hacer
			Escribir Sin Saltar "(",calculadora(2,i,j),")"
		FinPara
		Escribir ""
	FinPara
FinSubProceso
